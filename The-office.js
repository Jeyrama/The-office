...
When you should have been doing your real job, 
you've been using the work computers to go on leetcode.

In a team meeting, a person declares to the group that you aren't working. 
You're in trouble. You quickly have to gauge the feeling in the room to 
...
function outed(meet, boss){
  ...
  for (item in meet){
    if (item === boss) {
      totalHappiness += (meet[item] *2) 
    } else { totalHappiness += meet[item]}
  }
